...
astrArguments.append('org.muhkuh.tests')
astrArguments.append('ramtest')
astrArguments.append('lua5.1-ramtest')
astrArguments.append(strCurrentVersion)
