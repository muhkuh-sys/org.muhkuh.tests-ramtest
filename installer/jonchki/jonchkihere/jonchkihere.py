...
def install(strCfg_JonchkiVersion, strCfg_OutputFolder, **kwargs):
    ...
    for strKey, tValue in iter(kwargs.items()):
        if strKey == 'LOCAL_ARCHIVES':
            ...
            strCfg_LogLevel = tValue

    logging.basicConfig(level=strCfg_LogLevel)
...
if __name__=='__main__':
    ...
    install(atArgs.strJonchkiVersion, atArgs.strOutputFolder, LOCAL_ARCHIVES=atArgs.strLocalArchivesFolder, LOG_LEVEL=logging.DEBUG)
